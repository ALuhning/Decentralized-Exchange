    ...
    describe('sending tokens', () => {
        ...
        describe('failure', async () => {
            ...
            it('rejects insufficient balances', async () => {
                let invalidAmount
                invalidAmount = tokens(100000000) // 100 million - greather than supply of tokens
        ...
        describe('failure', async () => {
            ...
            it('rejects insufficient amounts', async () => {
               // Attempt transfer too many tokens
                const invalidAmount = tokens(100000000) // 100 million - greather than supply of tokens
